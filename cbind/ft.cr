...
lib FT
  ...
  alias GlyphMetrics = Void

  alias BitmapSize = Void

  alias LibraryRec = Void
  ...
  alias GlyphSlotRec = Void

  alias Parameter = Void

  alias OpenArgs = Void

  alias SizeRequestRec = Void
