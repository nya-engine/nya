...
lib SDL2
  ...
  fun peep_events = "SDL_PeepEvents"(events : Event*, numevents : Int16, action : Eventaction, min_type : UInt16, max_type : UInt16) : Int16
  fun has_event = "SDL_HasEvent"(type : UInt16) : Bool
  fun has_events = "SDL_HasEvents"(min_type : UInt16, max_type : UInt16) : Bool
  fun flush_event = "SDL_FlushEvent"(type : UInt16) : Void
  fun flush_events = "SDL_FlushEvents"(min_type : UInt16, max_type : UInt16) : Void
  ...
  fun event_state = "SDL_EventState"(type : UInt16, state : Int16) : UInt8
